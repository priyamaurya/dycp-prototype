...
router.use('/supplier-information-v4', require('./views/supplier-information-v4/routes'))
...
router.use('/supplier-information-v5', require('./views/supplier-information-v5/routes'))
