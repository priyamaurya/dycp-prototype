...
var oRoute = {
    ...
    "/other-org-with-control-service-address-2":"other-org-with-control-ch-equivalent-overseas-2",
    ...
    "/category-other-indvidual-with-control-adress-2":"category-other-indvidual-with-control-ch-equivalent-overseas-2",
    "/category-other-indvidual-with-control-ch-equivalent-overseas-2":"category-other-indvidual-with-control-nature-of-control-2",
    "/category-other-indvidual-with-control-nature-of-control-2":"category-other-indvidual-with-control-registration-date-2",
    "/category-other-indvidual-with-control-registration-date-2":"category-other-indvidual-with-control-legal-form-2",
...
router.post('/is-parent-company-address-same-2', function (req, res, next) {
    if(req.body.isSameAddress == 'No')
        ...
        res.redirect('parent-company-service-address-2');
});
...
router.post('/is-other-org-with-control-address-same-2', function (req, res, next) {
    if(req.body.isSameAddress == 'No')
        ...
        res.redirect('other-org-with-control-service-address-2');
});
